...
def page(events,bjzs,ext,errors,now,notes):
 rows=[]
 research=[]
 for e in events:
...
def main():
 ...
 (DOCS/'index.html').write_text(page(events,bjzs,ext,errors,now,notes),encoding='utf8')
