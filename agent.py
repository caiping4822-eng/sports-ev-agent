...
def page(events,bjzs,ext,errors,now,notes,goalodds,movements):
 rows=[]
 research=[]
 models=[]
 for e in events:
...
def main():
 ...
 (DOCS/'index.html').write_text(page(events,bjzs,ext,errors,now,notes,goalodds,moves),encoding='utf8')
