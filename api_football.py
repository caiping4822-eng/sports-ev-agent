...
import re
TEAM_MAP={
"中日德兰":["FC Midtjylland","Midtjylland"],"贝西克塔":["Besiktas","Beşiktaş"],"帕佛斯":["Pafos","Pafos FC"],"斯海杜克":["Hajduk Split","Hajduk"],"安德莱赫":["Anderlecht"],"哈马比":["Hammarby","Hammarby FF"],"费伦茨瓦":["Ferencvaros","Ferencváros"],"特温特":["Twente","FC Twente"],"本菲卡":["Benfica"],"圣加仑":["St Gallen","St. Gallen"],"科林蒂安":["Corinthians"],"巴竞技":["Athletico Paranaense","Athletico-PR"],"图凯拉特":["Kairat","Kairat Almaty"],"奥莫尼亚":["Omonia","Omonia Nicosia"],"波兹莱赫":["Lech Poznan","Lech Poznań"],"奥胡斯":["AGF","Aarhus"],"米拉索":["Mirassol"],"雷莫":["Remo"],"巴西国际":["Internacional"],"弗拉门戈":["Flamengo"],"弗鲁米嫩":["Fluminense"],"巴伊亚":["Bahia"],"维多利亚":["Vitoria","Vitória"],"帕梅拉斯":["Palmeiras"],"瓦勒伦加":["Vålerenga","Valerenga"],"汉坎":["HamKam","Ham Kam"],"博德闪耀":["Bodø/Glimt","Bodo/Glimt","Bodo Glimt"],"利勒斯特":["Lillestrøm","Lillestrom"],"纽约城":["New York City FC","NYCFC"],"多伦多":["Toronto FC"],"江原FC":["Gangwon FC"],"富川FC":["Bucheon FC","Bucheon FC 1995"],"全北现代":["Jeonbuk Hyundai Motors","Jeonbuk Hyundai"],"首尔FC":["FC Seoul"],"浦项制铁":["Pohang Steelers"],"金泉尚武":["Gimcheon Sangmu"],"蔚山现代":["Ulsan HD","Ulsan Hyundai"],"FC安养":["FC Anyang"],"济州SK":["Jeju SK","Jeju United"],"仁川联队":["Incheon United"],"大田市民":["Daejeon Hana Citizen","Daejeon Citizen"],"光州FC":["Gwangju FC"]}
