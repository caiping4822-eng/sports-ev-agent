...
# Norway Eliteserien
"瓦勒伦加":["Valerenga","Vålerenga","Valerenga Fotball"],"汉坎":["HamKam","Ham Kam"],
"博德闪耀":["Bodo/Glimt","Bodø/Glimt","Bodo Glimt"],"利勒斯特":["Lillestrøm","Lillestrom"],
# MLS
"纽约城":["New York City FC","NYCFC"],"多伦多":["Toronto FC"],
# South Korea K League
"江原FC":["Gangwon FC"],"富川FC":["Bucheon FC","Bucheon FC 1995"],
"全北现代":["Jeonbuk Hyundai Motors","Jeonbuk Hyundai"],"首尔FC":["FC Seoul"],
"浦项制铁":["Pohang Steelers"],"金泉尚武":["Gimcheon Sangmu"],
"蔚山现代":["Ulsan HD","Ulsan Hyundai"],"FC安养":["FC Anyang"],
"济州SK":["Jeju SK","Jeju United"],"仁川联队":["Incheon United"],
"大田市民":["Daejeon Hana Citizen","Daejeon Citizen"],"光州FC":["Gwangju FC"]}
